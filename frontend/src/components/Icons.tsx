/** Minimal inline icons — no lucide-react dependency */

export function IconFlask({ size = 18 }: { size?: number }) {
  return (
...
export function IconCircle({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <circle cx="12" cy="12" r="10" />
    </svg>
...
export function IconLoader({ size = 18 }: { size?: number }) {
  return (
